...
function buildValidationMessage(errors) {
  ...
  return `Resource creation failed. \n\nThe resource name can only contain letters, numbers, and spaces. Please correct the field and try again.`;
}
...
async function onSubmit(event) {
  ...
  try {
    ...
    const msg = `Resource "${body?.data?.name}" was added successfully.`;
